/*3.Write a menu driven program to perform the following operations of a stack
using dynamic array by using suitable user defined functions for each case.*/
